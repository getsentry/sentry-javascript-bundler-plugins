...
### New behabiour of `entries` option
...
Instead of _entrypoints_, the `entries` option will now be used though to filter for _modules_ that the plugin should inject the release into.
