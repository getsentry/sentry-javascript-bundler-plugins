...
| stripPrefix        | `array`                                                                    | optional | When paired with the `rewrite`, this will remove a prefix from filename references inside of sourcemaps. For instance you can use this to remove a path that is build machine specific. Note that this will NOT change the names of uploaded files.                                                                                                                                                                                                                                                                                                           |
